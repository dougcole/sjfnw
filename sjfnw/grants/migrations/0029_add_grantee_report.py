    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.CharField(default=b'text', help_text=b'Select the type of for input to use for this question.', max_length=20, choices=[(b'text', b'Text box'), (b'short_text', b'Single-line text input'), (b'number', b'Number')])),
